    ...
    public partial class Shimmer : global::Java.Lang.Object
    {
        public partial class AlphaHighlightBuilder : global::Facebook.Shimmer.Shimmer.Builder
        {
            ...
            protected override Java.Lang.Object RawThis
            {
                get
                {
                    return new Java.Lang.Object(JNIEnv.CallObjectMethod(Handle, JNIEnv.GetMethodID(JNIEnv.GetObjectClass(Handle), "getThis", "()Lcom/facebook/shimmer/Shimmer$Builder;")), JniHandleOwnership.TransferLocalRef);
                }
            }
        }
